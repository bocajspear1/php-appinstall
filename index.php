...
<body>
	<div id="main">
		<label>Download Link: </label><input id="download-link" name="download-link" type="text" /><br>
		<label>Instance Name: </label><input id="instance-name" name="instance-name" type="text" maxlength="16"/><br>
